...
wait = 200  # пробел времени у '.' в азбуке Морзе
# частоты, которые можно выбирать
frequency_list = [3.505, 3.515, 3.522, 3.532, 3.535, 3.542, 3.545, 3.552, 3.555, 3.565, 3.572, 3.575, 3.582, 3.592, 3.595, 3.600]
# азбука морзе
A = '._'
B = '_...'
C = '_._.'
